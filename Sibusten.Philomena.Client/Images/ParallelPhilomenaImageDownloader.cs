...
namespace Sibusten.Philomena.Client.Images
{
    public class ParallelPhilomenaImageDownloader : IParallelPhilomenaImageDownloader
    {
        ...
        public async Task Download(IAsyncEnumerable<IPhilomenaImage> imagesToDownload, CancellationToken cancellationToken = default, ICollection<IProgress<DownloadProgressInfo>>? progress = null)
        {
