...
namespace Sibusten.Philomena.Client.Extensions
{
    ...
    {
        public static async Task DownloadToFile(this IPhilomenaImage image, string filename, CancellationToken cancellationToken = default, IProgress<DownloadProgressInfo>? progress = null)
        {
